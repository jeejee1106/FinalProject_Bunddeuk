			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center">
					...
					<c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
						...
						<c:if test="${currentPage != i}">
							<li class="page-item"><a class="page-link" href="created_sponsorlist?idx=${pdto.idx}&currentPage=${i}">${i}</a></li>
						</c:if>
					</c:forEach>
					...
					<li class="page-item">
						<a class="page-link" href="created_sponsorlist?idx=${pdto.idx }&currentPage=${ph.endPage + 1}" aria-label="Next">
