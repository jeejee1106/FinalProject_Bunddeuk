	...
	<div class="created-wrapper">
		<div class="project-wrapper">
 			<div class="project-count">
				<em style="color: red;">${myTotalProjectCnt}</em> 개의 프로젝트가 있습니다.
			</div>
			<c:if test="${sessionScope.sessionId == dto.id }">
			...
			<div class="project-list">
				<c:if test="${empty myTotalProjectCnt }">
					<div class="list-zero">
				...
				<div id="all">
					<c:if test="${myTotalProjectCnt>0 }">
						<c:if test="${sessionScope.sessionId == dto.id }">
							<!-- 작성중인 프로젝트 리스트 -->
							<div id="write">
								<br><br><br>
								<div class="project-status">
									<div class="project-status-tag"><b>작성 중 ${creatingProjectCnt}</b></div>
								</div>
							...
							<div id="audit">
								<br><br><br>
								<div class="project-status">
									<div class="project-status-tag"><b>심사 중 ${reviewingProjectCnt}</b></div>
								</div>
								<c:forEach var="c" items="${creativeList }">
								<c:if test="${c.audit == 1 }">
									<div class="project-card">
						...
						<div id="approval">
							<br><br><br>
							<div class="project-status">
								<div class="project-status-tag"><b>승인됨 ${approvalProjectCnt}</b></div>
							</div>
							<c:forEach var="c" items="${creativeList }">
							<c:if test="${c.audit == 3 }">
								<div class="project-card">
